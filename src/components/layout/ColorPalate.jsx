...
function ColorPalate({ id, colorObj, updateLock,onUpdateColor, showToast,setRandomColors, }) {
  ...
  return (
    <div
      ...
      className="flex-1 h-full flex items-center justify-center hover:flex-[1.3] transition-[flex] duration-300 ease-in-out"
    >
